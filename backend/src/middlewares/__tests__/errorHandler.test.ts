...
describe("ErrorHandlerMiddleware", () => {
  ...
  describe("getSeverityFromErrorCode", () => {
    it("should return correct severity for validation errors", () => {
      const validationError = new ValidationError("Test");
      expect(
        errorHandler["getSeverityFromErrorCode"](ErrorCodes.VALIDATION_ERROR),
      ).toBe(ErrorSeverity.LOW);
      expect(
        errorHandler["getSeverityFromErrorCode"](ErrorCodes.INVALID_EMAIL),
      ).toBe(ErrorSeverity.LOW);
    });

    it("should return correct severity for business logic errors", () => {
      expect(
        errorHandler["getSeverityFromErrorCode"](
          ErrorCodes.BUSINESS_LOGIC_ERROR,
        ),
      ).toBe(ErrorSeverity.MEDIUM);
      expect(
        errorHandler["getSeverityFromErrorCode"](ErrorCodes.USER_NOT_FOUND),
      ).toBe(ErrorSeverity.MEDIUM);
    });
    ...
    it("should return correct severity for authentication errors", () => {
      ...
      expect(
        errorHandler["getSeverityFromErrorCode"](ErrorCodes.TOKEN_EXPIRED),
      ).toBe(ErrorSeverity.HIGH);
    });

    it("should return correct severity for database errors", () => {
      expect(
        errorHandler["getSeverityFromErrorCode"](ErrorCodes.DATABASE_ERROR),
