...
export default function TabsLayout({ children }: { children: ReactNode }) {
  ...
  const tabs = [
    {
      ...
      value: "active",
      href: "/onboarding/dashboard/active",
      component: <div />,
    },
    {
      label: "Completed",
      value: "completed",
      href: "/onboarding/dashboard/completed",
      component: <div />,
    },
    {
      label: "Analytics",
    ...
    },
    {
      label: "Dispute",
      value: "dispute",
      href: "/onboarding/dashboard/dispute",
      component: <div />,
    },
  ];
  ...
  return (
    <>
      <h1 className="text-sm text-gray-700 bg-white p-4 rounded-lg text-center mb-6 font-semibold">
        {sectionTitle}
      </h1>
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg overflow-hidden">
        ...
        />
        <div className="mt-8 max-h-[70vh] overflow-y-auto no-scrollbar pr-1">
          {children}
        </div>
      </div>
    </>
