...
export const mockPortfolioProjects: PortfolioProject[] = [
  {
    ...
    description:
      "A comprehensive e-commerce platform built with modern technologies. Features include user authentication, product catalog, shopping cart, payment processing, and admin dashboard.",
  ...
  },
  {
    ...
    description:
      "A modern mobile banking application designed for seamless user experience. Features include account management, fund transfers, bill payments, and financial analytics.",
  ...
  },
  {
    ...
    title: "CRM System",
    description:
      "A comprehensive Customer Relationship Management system designed for sales teams. Features include lead management, contact tracking, sales pipeline, and reporting.",
    category: "Web Development",
  ...
  },
  {
    ...
    description:
      "A modern travel booking platform with flight, hotel, and car rental booking capabilities. Features include search, booking, payment, and itinerary management.",
    category: "Web Development",
  ...
  },
  {
    ...
    description:
      "A comprehensive fitness tracking application with workout planning, progress tracking, and social features. Includes both mobile app and web dashboard.",
    category: "Mobile Development",
  ...
  },
  {
    ...
    description:
      "A complete restaurant management solution including POS, inventory management, online ordering, and analytics dashboard.",
    category: "Web Development",
