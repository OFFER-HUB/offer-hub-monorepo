...
export const mockProjects: MockProject[] = [
  {
    ...
    description:
      "Design a modern mobile application interface with user experience optimization",
    status: "in-progress",
    budget: "$2,500",
    freelancer: {
      id: "freelancer-001",
  ...
  },
  {
    ...
    description:
      "Full-stack development of an e-commerce platform with payment integration",
    status: "active",
    budget: "$5,000",
    freelancer: {
      id: "freelancer-002",
