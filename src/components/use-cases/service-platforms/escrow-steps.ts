import { FileCheck, ShieldCheck, Layers, Zap } from "lucide-react";
import type { EscrowStep } from "@/components/use-cases/shared/EscrowFlowDiagram";

export const SERVICE_PLATFORMS_ESCROW_STEPS: EscrowStep[] = [
  {
    stepNumber: 1,
    label: "Scope & SOW",
    status: "CREATED",
