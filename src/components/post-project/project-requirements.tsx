...
export default function ProjectRequirements({
  ...
  const removeSkill = (skill: string) => {
    updateProjectData(
      "skills",
      projectData.skills.filter((s: string) => s !== skill),
    );
  };
      ...
      <motion.div variants={item}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Define the skills and experience level needed for your project
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateProjectData("experienceLevel", value)
                }
              >
              ...
              <p className="text-sm text-muted-foreground">
                This helps match your project with freelancers of the right
                experience level
              </p>
            </div>
            ...
            <Alert className="bg-[#DEEFE7]/30 border-[#15949C]">
              ...
              <AlertDescription className="text-[#002333]/70">
                Clearly defined requirements help attract qualified freelancers
                and result in more accurate proposals.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
