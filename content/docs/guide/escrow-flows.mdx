...
Lifecycle events are delivered over the [SSE event stream](/docs/api-reference/webhooks) at `GET /api/v1/events` — there is no outbound webhook API. Subscribe to keep your application in sync:
