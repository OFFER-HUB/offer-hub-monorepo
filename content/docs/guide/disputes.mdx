...
// Open a dispute
const dispute = await sdk.orders.dispute('ord_xyz789', {
...
Dispute lifecycle events are delivered over the [SSE event stream](/docs/api-reference/webhooks) at `GET /api/v1/events` — there is no outbound webhook API:
