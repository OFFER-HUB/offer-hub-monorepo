...
| Endpoint | Method | Description |
|----------|--------|-------------|
| `/users/{userId}/wallet` | <Badge variant="success">GET</Badge> | [Get wallet info](/docs/api-reference/wallet-topups#get-usersuseridwallet) |
| `/users/{userId}/wallet/deposit` | <Badge variant="success">GET</Badge> | [Get deposit address](/docs/api-reference/wallet-topups#get-usersuseridwalletdeposit) |
| `/users/{userId}/wallet/transactions` | <Badge variant="success">GET</Badge> | [Transaction history](/docs/api-reference/wallet-topups#get-usersuseridwallettransactions) |
...
| `/topups/{id}` | <Badge variant="success">GET</Badge> | [Get top-up](/docs/api-reference/wallet-topups#get-topupsid) |
| `/topups/{id}/refresh` | <Badge variant="primary">POST</Badge> | [Refresh status from AirTM](/docs/api-reference/wallet-topups#post-topupsidrefresh) |
| `/topups/{id}/cancel` | <Badge variant="primary">POST</Badge> | [Cancel top-up](/docs/api-reference/wallet-topups#post-topupsidcancel) |
| `/topups/{id}/callback` | <Badge variant="success">GET</Badge> | [AirTM callback (public)](/docs/api-reference/wallet-topups#get-topupsidcallback) |
