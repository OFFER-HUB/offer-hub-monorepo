...
<Callout type="tip">
  **OpenAPI 3.0 Specification Available:** Download the full machine-readable OpenAPI 3.0 schema directly at [`/openapi.json`](/openapi.json) or test all verified endpoints in the [Interactive API Explorer](/docs/api-reference/interactive). Generated via `scripts/generate-openapi.ts`.
</Callout>
