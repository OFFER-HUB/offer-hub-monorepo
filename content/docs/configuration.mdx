...
<Callout type="note">
  AirTM is the fiat on/off-ramp provider. For the full setup — user linking, top-ups, withdrawals, callback redirects, and webhook verification — see the [AirTM Provider Guide](/docs/guide/airtm).
</Callout>
